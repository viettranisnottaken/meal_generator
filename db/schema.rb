...
ActiveRecord::Schema.define(version: 2019_12_24_021716) do
  ...
  create_table "dish_categories", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["category_id"], name: "index_dish_categories_on_category_id"
  ...
  create_table "dish_types", force: :cascade do |t|
    ...
    t.index ["type_id"], name: "index_dish_types_on_type_id"
  end
  ...
  create_table "meal_menus", force: :cascade do |t|
    ...
    t.index ["menu_id"], name: "index_meal_menus_on_menu_id"
  end
